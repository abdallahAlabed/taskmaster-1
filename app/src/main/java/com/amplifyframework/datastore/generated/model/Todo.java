...
public final class Todo implements Model {
  ...
  private Todo(String id, String title, String state, String img, String body, Team team) {
    this.id = id;
    this.title = title;
    this.state = state;
    this.img = img;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String state, String img, String body, Team team) {
      super.id(id);
      super.title(title)
        .state(state)
        .img(img)
